    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-6 botoes">
          ...
          <p>
            A propriedade fica a 4,4 km da estação rodoviária de Petrópolis e a
            5,8 km da Catedral de São Pedro de Alcântara. <br />O aeroporto mais
            próximo é o Aeroporto Internacional do Galeão/Rio de Janeiro, a 61
            km do Lofts de Luxo Palácio Quitandinha Petrópolis.{" "}
          </p>
          <p>
            Quartos para famílias, Instalações para pessoas com deficiência,
            Quartos para não fumantes
  ...
  <div id="about-area">
    <div className="container">
      <div className="row">
        <div className="col-md-6">
          <h3>Italia-Roma</h3>
          <img className="img-fluid" src="../Img/roma.jpg" alt="Roma- Italia" />
        </div>
        <div className="col-md-6 botoes">
          ...
          <ul id="about-list">
            ...
            <li>
              <i className="fas fa-check" />
              NH Collection Roma Fori Imperiali- Via di Santa Eufemia, 19 00187,
              Roma - Itália 0.41 km Foro Romano
            </li>
            <li>
              <i className="fas fa-check" />
              utilização de algo{" "}
